...
<script setup lang="ts">
    ...
    const links = ref([{name: 'Intro', idName: "intro", isActive: false }, {  name: 'About me', idName: "about", isActive: false}, {name: 'Contact', idName: "contact", isActive: false}])
    ...
    onMounted(() => {
        ...
        const scrollWrapperElement = document.getElementById("scroll-wrapper") as HTMLElement;
...
<template>
    <div class="navigation-bar">
        ...
        <nav class="navigation-links">
            <NavigationButton v-for="link in links" :idName="link.idName" :name="link.name" :isActive="link.idName === currentActive"/>
        </nav>
    </div>
</template>