...
// Graphic Design
const graphicDesignProjectData: TProject = {
    name: 'Graphic Design',
    description:
...
// Photography
const photographyProjectData: TProject = {
    name: 'Photography',
    description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
    outerImageUrl: `${GOOGLE_DRIVE_FILE_PREFIX}1um8l3MdLOjCXBRS_3VuZUMxefPh-HmON`,
    introImageUrl: [
        `${GOOGLE_DRIVE_FILE_PREFIX}1j2sU-c9RQJWSPCLVNFDMdPsuV1g-k2ko`,
        `${GOOGLE_DRIVE_FILE_PREFIX}1kQ_8X5-lVVw6wP52-YaoeCOt-_oMjD72`,
        `${GOOGLE_DRIVE_FILE_PREFIX}1K1JXkFZdV7UHwwP9-e6UIQVgcaAMSg_4`,
    ],
    demoImages: {
        mainImageUrl: `${GOOGLE_DRIVE_FILE_PREFIX}1mwA6VfnYvpHLvzvPru8JGo29AeI_sXCK`,
        subImageUrls: [
            `${GOOGLE_DRIVE_FILE_PREFIX}14SgPy8KBE7yqofBHKflYF2cF4Wn3N8pj`,
            `${GOOGLE_DRIVE_FILE_PREFIX}1jxV_CuH23sSnUSD4OxABoDMD7ZCbdQdu`,
            `${GOOGLE_DRIVE_FILE_PREFIX}1WA5ngHq8n9DIVgZv14iX15HIBTZXcYqT`,
        ],
    },
    brands: [
        {
            ...
            logoURL: `${BRAND_LOGO_URL_PREFIX}50_megumi.png`,
            postImageUrls: [
                `${GOOGLE_DRIVE_FILE_PREFIX}1hU0ZkM23ADuklmwC7RKTr_yul6MhXiXI`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1um8l3MdLOjCXBRS_3VuZUMxefPh-HmON`,
                `${GOOGLE_DRIVE_FILE_PREFIX}14VCwVsKwHb7ctMRR6HtFQyk-PE9IE_dJ`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1mwA6VfnYvpHLvzvPru8JGo29AeI_sXCK`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1-A8-EszC_wgxMENvfaLaHqEYjlZYinRK`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1AQypELESxdEH0Z09A2tg6bRS3-1L4zLA`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1G5nHZGaA6ykKWbLHc8dstfaw55rPEPPa`,
            ],
        },
        {
            name: 'Flawsome',
            ...
            postImageUrls: [
                `${GOOGLE_DRIVE_FILE_PREFIX}1j2sU-c9RQJWSPCLVNFDMdPsuV1g-k2ko`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1q3mApdikzBWWnEf0FbgULEg9PemLV_Nl`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1pgxeG6Zpau4BcsvkXc2O0FXiF5KfRSkC`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1ZG2GUkjHD-aPjKJ3A2XZggjA1omyRFDn`,
                `${GOOGLE_DRIVE_FILE_PREFIX}18HmBVpbv7lekRDzZsDjK_-q90rZogBqk`,
                `${GOOGLE_DRIVE_FILE_PREFIX}15IKNZ0XzdrJWfZw6UXF0FM-IVwkjUHTy`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1Etm9PpY9B0fxAYmb8s1XUeUmJcnKZtfc`,
                `${GOOGLE_DRIVE_FILE_PREFIX}14SgPy8KBE7yqofBHKflYF2cF4Wn3N8pj`,
                `${GOOGLE_DRIVE_FILE_PREFIX}13eSGbL_oWmASHXglVSHFvWXjKu37jBMy`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1_tHXM2uhgV0UG13uu8Fe1rpK3bppYNux`,
            ],
        },
        {
            name: 'Lip On Lip',
            ...
            postImageUrls: [
                `${GOOGLE_DRIVE_FILE_PREFIX}1kQ_8X5-lVVw6wP52-YaoeCOt-_oMjD72`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1WA5ngHq8n9DIVgZv14iX15HIBTZXcYqT`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1d52vOsrv2J-ut21DG7gKxOvJBQNKVo_K`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1jxV_CuH23sSnUSD4OxABoDMD7ZCbdQdu`,
            ],
        },
        {
            ...
            logoURL: `${BRAND_LOGO_URL_PREFIX}lipstician.png`,
            postImageUrls: [
                `${GOOGLE_DRIVE_FILE_PREFIX}12fk5Re1HRFYnlhkvUI6V7PnO_TSEyIq7`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1zTLefVcDA8LEcEvYCwhLh923CEOKQvH5`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1K1JXkFZdV7UHwwP9-e6UIQVgcaAMSg_4`,
                `${GOOGLE_DRIVE_FILE_PREFIX}12tsnWNHtIkMX2PKydIAahaOSy3bLzIAf`,
                `${GOOGLE_DRIVE_FILE_PREFIX}1R_iifOvmGp9m0lktpvZ2MlcmHuq-7r3U`,
            ],
        },
        {
            name: 'Sunplay',
            logoURL: `${BRAND_LOGO_URL_PREFIX}skin_aqua.png`,
            postImageUrls: [
                `${GOOGLE_DRIVE_FILE_PREFIX}10sxloLFo0_hOgQunwMJJs951OKTE7t53`,
            ],
        },
    ],
};
...
export const projectMockData: Array<TProject> = [
    graphicDesignProjectData,
    photographyProjectData,
];
